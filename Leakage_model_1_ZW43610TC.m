...
%%%%%Writen by Ren Ren from University of Tennessee%%%%%%%%
...
for i = 1:1:length_core
    ...
    %k=Rout_air/Rout_f
    k = (2 * ht * 1e-3 / ((pi - theta) / 2) * log(1 / cos((pi - theta) / 2)) + 1.75/2 * df * 1e-3) / (1.75 * df * 1e-3);
...
figure(1);
hold on;
plot(Nt(167:175), Llk5(167:175))
hold off;
figure(2);
hold on;
plot(Nt(167:175), abs(Error2(167:175)))
hold off;

% figure(1);
% hold on;
% plot(Nt(26:34),Llk5(26:34))
% hold off;
% figure(2);
% hold on;
% plot(Nt(26:34),abs(Error2(26:34)))
% hold off;
